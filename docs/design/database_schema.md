...
记录积分变化、签到、勋章、优惠券、等级与活动信息。相关表包括 `tb_credit_record`, `tb_sign`, `tb_medal`, `tb_user_medal`, `tb_voucher`, `tb_user_voucher`, `tb_level_rule`, `tb_activity`, `tb_user_activity` 等。
